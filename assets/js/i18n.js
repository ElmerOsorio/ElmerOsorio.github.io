...
const DICTIONARY = {
  es: {
    ...
    'projects.body': 'Reemplaza estos cuatro casos por proyectos reales. Cada tarjeta enlaza a una copia de la plantilla incluida.',
    ...
    'projects.card2.title': 'Proyecto financiero',
    'projects.card2.desc': 'Rediseño de una experiencia crítica con foco en claridad, confianza y conversión.',
    'projects.card2.meta': 'Product Design<br>2024',
    'projects.card3.title': 'Design system',
    'projects.card3.desc': 'Sistema modular para acelerar consistencia, colaboración y entrega entre equipos.',
    'projects.card3.meta': 'Design Systems<br>2024',
    'projects.card4.title': 'Producto digital',
    'projects.card4.desc': 'Diseño end-to-end desde la investigación hasta la validación con usuarios.',
    'projects.card4.meta': 'UX / UI<br>2023',
  ...
  en: {
    ...
    'projects.body': 'Replace these four cases with real projects. Each card links to a copy of the included template.',
    'projects.card1.title': 'Home',
    'projects.card1.desc': 'Restructuring an ecommerce homepage: smart search, load times and WCAG 2.2 accessibility.',
    'projects.card1.meta': 'UX Designer<br>2024',
    'projects.card2.title': 'Financial project',
    'projects.card2.desc': 'Redesign of a critical experience focused on clarity, trust and conversion.',
    'projects.card2.meta': 'Product Design<br>2024',
    'projects.card3.title': 'Design system',
    'projects.card3.desc': 'Modular system to speed up consistency, collaboration and delivery across teams.',
    'projects.card3.meta': 'Design Systems<br>2024',
    'projects.card4.title': 'Digital product',
    'projects.card4.desc': 'End-to-end design from research to user validation.',
    'projects.card4.meta': 'UX / UI<br>2023',
